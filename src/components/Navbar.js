...
const Navbar = (props) => {
  return (
  	<nav>
			<ul className="navbar">
				<li className="navbar__list"><NavLink className="navbar__link" exact={true} to="/" activeStyle={{color: '#A9A9A9'}}>Home</NavLink></li>
				<li className="navbar__list"><NavLink className="navbar__link" to="/weather" activeStyle={{color: '#A9A9A9'}}>Weather</NavLink></li>
